...
#se pueden hacer funciones dd cambio de color de ventana, puede ser util para otras elecciones

# se crea la funcion y dentro de la variable de radionutton se aplica el comandd= y ahi se empaqueta
