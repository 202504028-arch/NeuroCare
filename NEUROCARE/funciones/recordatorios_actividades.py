...
#FUNCIONES
    ...
    def cargar_recordatorios(self):
        ...
        try:
            ...
            cursor.execute(
                ...
                "FROM recordatorio WHERE idPaciente = %s AND tipoRecordatorio = 'Actividad' "
        ...
        if not recordatorios:
            tk.Label(self.contenedor, text="No hay recordatorios de actividades registrados.",
    ...
    def crear_tarjeta(self, rec):
        ...
        tarjeta = ctk.CTkFrame(self.contenedor, fg_color="white",
        ...
        ctk.CTkButton(fila_top, text=texto_estado, width=110, height=28,
        ...
        ctk.CTkButton(fila_bot, text="Eliminar", width=90, height=30,
        ...
        ctk.CTkButton(fila_bot, text="Editar", width=90, height=30,
...
if __name__ == "__main__":
    ...
    app = recordatorios_actividadees(
        ventana,
        idPaciente
    )
